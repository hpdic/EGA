...
def main():
    ...
    feat_path = os.path.join(base_dir, 'embeddings/food101_features.npy')
    label_path = os.path.join(base_dir, 'embeddings/food101_labels.npy')
    model_save_path = os.path.join(base_dir, 'models/ega_food101.pth')
    ...
    model.train()
    print("Training EGA on Food-101 (150 epochs)...")
